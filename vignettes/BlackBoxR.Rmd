...
performABtest_Freq() : Run A\B test using the Frequentist approach
...
distribution: type of distribution of the data. for example (bernoulli, bernoulli). Support for 2 as of now.
...
```
```
performABtest_Freq(data,alpha = 0.05)
